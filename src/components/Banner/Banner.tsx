    ...
    return (
        <div className="bg-[#FFFFFF]">
            <div className="max-w-[82rem] mx-auto">
                <div className="items-center lg:flex min-h-[calc(100vh-80px)]">
                    {/* image */}
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="lg:max-w-l space-y-3.5">
                            <button className="flex items-center gap-1.5 h-11 bg-[#00233F] rounded-2xl px-3 py-1`">
                            ...
                            <h1 className="text-6xl font-semibold leading-tight">Smart Investments <br /> for Verified SMEs</h1>
                            <p className="leading-relaxed">Smart Investments for Verified SMEs connects investors with vetted small <br /> businesses, promoting informed decisions and local economic growth</p>
                            <div className="flex items-center gap-6 pt-3">
                                <button className="btn bg-[#005397] text-white font-normal rounded-full">Start Investing</button>
                                <button className="btn btn-outline border-[#005397] font-normal text-black rounded-full">Get Funded</button>
                            </div>
