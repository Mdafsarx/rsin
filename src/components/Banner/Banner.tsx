    ...
    return (
        <div className="bg-[#FFFFFF]">
            <div className="max-w-[82rem] mx-auto">
                <div className="flex flex-col md:flex-row items-center  min-h-[calc(80vh-80px)]  md:min-h-[calc(100vh-80px)]">
                    {/* image */}
                    <div className="hidden md:flex items-center gap-4 md:w-1/2">
                    ...
                    <div className="w-full md:w-1/2 p-8 md:p-0">
                        <div className="md:max-w-l space-y-3.5 flex flex-col items-center md:items-start">
                            ...
                            <h1 className="text-4xl md:text-6xl font-semibold leading-tight text-center md:text-start">Smart Investments <br /> for Verified SMEs</h1>
                            <p className="leading-relaxed text-balance text-center md:text-start">Smart Investments for Verified SMEs connects investors with vetted small <br /> businesses, promoting informed decisions and local economic growth</p>
