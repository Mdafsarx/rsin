export default function OurFinance() {
    return (
        <div className="flex items-center gap-8 max-w-[82rem] mx-auto">

            {/* images */}
            <div className="bg-[#EFF1F5] py-8 mt-3 w-1/2 rounded-2xl flex items-center">
                <div >
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <img src="https://res.cloudinary.com/dz1fy2tof/image/upload/v1734494617/Rectangle_1771_k7xvpb.png" alt="" className="w-[45%] rounded-md -mb-32" />
                    </div>
                    <div className="flex justify-center">
                        <div className="bg-[#26FC0326] size-[260px] -mt-28 rounded-md"></div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-1/2 space-y-4">
                ...
                <h1 className="text-3xl font-bold">Our Finance Solutions</h1>
                ...
                <div className="flex items-center gap-6 pt-4">
                    <button className="btn text-white rounded-full font-normal bg-[#005397] px-5">Get Started</button>
                    <button className="btn text-black rounded-full font-normal btn-outline border-[#005397] px-5">Learn more</button>
                </div>
            </div>
